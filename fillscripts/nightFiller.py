...
def fillerUserData(user_id, user_pw, library, hall, row, column):
    try:
        ...
        #  time.sleep(2)
        selectFromDropdown(driver, "//select[@name = 'raggruppamento_aree']", library)

        #  time.sleep(2)
        selectFromDropdown(driver, "//select[@name = 'area']", hall)
        ...
        clickOnButton(driver, f'//*[@id="data_inizio-container"]/div[3]/div[1]/table/tbody/tr[[{column}]/td[{row}]')
        ...
        print("Errore di prenotazione :  " + user_id)
